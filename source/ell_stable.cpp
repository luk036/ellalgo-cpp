...
// Instantiation
template std::tuple<CUTStatus, double> ell_stable::update(const std::tuple<Arr, double>& cut);
template std::tuple<CUTStatus, double> ell_stable::update(const std::tuple<Arr, Arr>& cut);
