...
- Replace all occurrences of "Ell" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `Ell` means the name of the project, while `ell` is used in file names.
  - Remember to rename the `include/ell` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
